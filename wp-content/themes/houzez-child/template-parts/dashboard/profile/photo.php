...
<button id="select_user_profile_photo" type="button" class="btn btn-primary btn-full-width mt-3">
	<?php echo esc_html__('Actualizar foto de perfil', 'houzez'); ?>
</button>
<small class="form-text text-muted text-center"><?php echo esc_html__('Tamaño mínimo 300 x 300 px', 'houzez'); ?></small>
<small class="form-text text-muted text-center"><?php echo esc_html__('Tamaño máximo 1025 x 1025 px', 'houzez'); ?></small>
