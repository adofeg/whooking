    ...
    <div class="dashboard-header-wrap">
        <div class="d-flex align-items-center">
            <div class="dashboard-header-left flex-grow-1">
                <h1><?php echo houzez_option('dsh_actividad', 'Actividad'); ?></h1>
...
<section class="dashboard-content-wrap" id="bienvido-movil">
    <div class="dashboard-content-inner-wrap">
        <div class="dashboard-content-block-wrap">
            <?php get_template_part('template-parts/dashboard/custom/bienvenido'); ?>
        </div>
    </div>
</section>
            ...
            <div class="dashboard-content-block-wrap">
                ...
                <?php if (!empty($activities['data']['results'])) { ?>
                    <div class="row">
                            ...
                            <div class="dashboard-content-block activities-list-wrap">
                                <ul class="list-unstyled activities-list">
                                    ...
                                    foreach ($activities['data']['results'] as $activity) {
                                        ...
                                        $activity_id = $activity->activity_id; //@adolph
                                    ?>
                        ...
                        <div class="col-md-5 col-sm-12 lateral">

                            <?php get_template_part('template-parts/dashboard/custom/bienvenido'); ?>
                            <?php get_template_part('template-parts/dashboard/custom/regalos-clientes'); ?>
                            ...
                            <?php get_template_part('template-parts/dashboard/custom/sugerencias'); ?>
                            <?php get_template_part('template-parts/dashboard/custom/live-chat'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="dashboard-content-block">
                                <?php esc_html_e("No tienes ninguna actividad por el momento.", 'houzez'); ?>
