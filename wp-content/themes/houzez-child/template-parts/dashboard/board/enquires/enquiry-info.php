...
<div class="lead-detail-wrap">
	<h2><?php esc_html_e('Detalle de la solicitud', 'houzez'); ?></h2>
	<?php 
	// @adolph edit_enquiry_js  
	?>
	<ul class="list-unstyled mb-5">
		<li>
			<strong><?php esc_html_e('Contacto', 'houzez'); ?></strong><br>
		...
		<li>
			...
			<?php echo esc_attr($email); ?></strong></a>
		</li>
	
		</li>
		<li>
			<strong><?php esc_html_e('Tipo de solicitud', 'houzez'); ?></strong><br>
			<?php 
