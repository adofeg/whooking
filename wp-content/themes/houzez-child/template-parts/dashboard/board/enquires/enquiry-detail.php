            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12">
                    <ul class="nav nav-pills lead-nav-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#matching-listings" role="tab"><?php esc_html_e('Contactar con el Solicitante', 'houzez'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#notes" role="tab"><?php esc_html_e('Notas', 'houzez'); ?></a>
                        </li>
                    ...
                    <div class="dashboard-content-block tab-content">
                        ...
                        <div class="tab-pane fade show active" id="matching-listings" role="tabpanel">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                <a href="mailto:<?php echo esc_attr($lead->email); ?>" id="inquiry-send-email" class="btn btn-primary btn-slim"><i class="houzez-icon icon-envelope mr-1"></i> <?php esc_html_e('Send Via Email', 'houzez'); ?></a>
                                </div>    
                            </div>
                        ...
                        <div class="tab-pane fade" id="notes" role="tabpanel">
                            <div class="form-group">
                                <textarea class="form-control" id="note" rows="5" placeholder="<?php esc_html_e('Escribe tu nota aquí...', 'houzez'); ?>"></textarea>
                            ...
                            <button id="enquiry_note" class="btn btn-primary">
                                ...
                                <?php esc_html_e('Añadir Nota', 'houzez'); ?>
                            </button>
