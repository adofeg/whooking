<div class="dashboard-slide-panel-wrap enquiry-panel-js">
	<h2><?php esc_html_e('Añadir nueva solicitud', 'houzez'); ?></h2>
	...
	<div class="lined-block">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Tipo de solicitud*', 'houzez'); ?></label>
			...
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					...
					<input class="form-control" name="e_meta[min-price]" id="min-price" placeholder="<?php esc_html_e('de', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label>&nbsp;</label>
					<input class="form-control" name="e_meta[max-price]" id="max-price" placeholder="<?php esc_html_e('hasta', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Bedrooms', 'houzez'); ?></label>
					<input class="form-control" name="e_meta[min-beds]" id="min-beds" placeholder="<?php esc_html_e('Min. de habitaciones', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label>&nbsp;</label>
					<input class="form-control" name="e_meta[max-beds]" id="max-beds" placeholder="<?php esc_html_e('Máx. de habitaciones', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Bathrooms', 'houzez'); ?></label>
					<input class="form-control" name="e_meta[min-baths]" id="min-baths" placeholder="<?php esc_html_e('Min. de baños', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label>&nbsp;</label>
					<input class="form-control" name="e_meta[max-baths]" id="max-baths" placeholder="<?php esc_html_e('Máx. de baños', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Area Size', 'houzez'); ?></label>
					<input class="form-control" name="e_meta[min-area]" id="min-area" placeholder="<?php esc_html_e('Min. metros construídos', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
			<div class="col-md-6 col-sm-12">
				<div class="form-group">
					<label>&nbsp;</label>
					<input class="form-control" name="e_meta[max-area]" id="max-area" placeholder="<?php esc_html_e('Máx. metros construídos', 'houzez'); ?>" type="text">
				</div>
			</div><!-- col-md-6 col-sm-12 -->
		</div>
	</div>
	<div class="lined-block">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
					<label><?php esc_html_e('Estado/Província', 'houzez'); ?></label>
	...
	<div class="lined-block">
		<h3><?php esc_html_e('Notas', 'houzez'); ?></h3>
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
