...
$ac_crm = $ac_insight = $ac_profile = $ac_props = $ac_add_prop = $ac_fav = $ac_search = $ac_invoices = $ac_msgs = $ac_mem = $ac_gdpr =$ac_ayuda = '';
...
}elseif ( is_page_template( 'template/user_dashboard_centroayuda' ) ) {
            ...
            if( !empty( $dashboard_centro_ayuda ) && houzez_check_role() ) {
                echo '<li class="side-menu-item">
                        <a '.esc_attr(  $ac_ayuda ).' href="'.esc_url($dashboard_centro_ayuda).'">
                            <i class="houzez-icon icon-alarm-bell mr-2"></i> Centro de Ayuda
                        </a>
                    </li>';
            }
