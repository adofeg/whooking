 ...
 * @since 2.0
 */
class Houzez_Elementor_Inquiry_Whooking_Form extends Widget_Base
{
    ...
    {
        return 'houzez_elementor_inquiry_whooking_form';
    }
    ...
    {
        return esc_html__('Inquiry Whooking Form', 'houzez-theme-functionality');
    }
    ...
    protected function _register_controls()
    {
         ...
         * Forms field types.
         */
        $field_types = apply_filters('houzez/inquiry_whooking_form/fields', $field_types);
...
?>
                        ...
                        <div class="gdpr-agreement-subgroup">
                            <span class="gdpr-field-option">
                                <label class="gdpr-text" for="gdpr_agreement">
                                    <input <?php if ($settings['gdpr_required']) {
                                                echo 'required';
                                            } ?> type="checkbox" title="<?php echo esc_attr($gdpr_validate); ?>" name="gdpr_agreement" id="gdpr_agreement"> <?php echo wp_kses($settings['gdpr_text'], $allowed_html); ?>
                                </label>
                            </span>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                $('select[name="e_meta[city]"]').change(function() {
                    valor = $(this).val();
                    objeto = $('select[name="e_meta[area]"]');
                    objeto.html('<option>Seleccione una ciudad</option>');
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            objeto.html('<option>Zona</option>');
                            objeto.append(result.data.opciones);
    ...
    ?>
        <div <?php echo $this->get_render_attribute_string('select-wrapper' . $i); ?>>
            <select <?php echo $this->get_render_attribute_string('select' . $i); if($item['field_type'] == 'e_meta[area]'){ echo "disabled";}?>>
                <?php
...
Plugin::instance()->widgets_manager->register_widget_type(new Houzez_Elementor_Inquiry_Whooking_Form);
